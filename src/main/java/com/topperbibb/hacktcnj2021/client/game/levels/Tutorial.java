...
public class Tutorial extends Level{
    ...
    public Map<String, Tile> mapObjects() {
        ...
        map.put( "o", new Tile(new TileInfo(SpriteManager.get("Basic_ground"), TileInfo.TileDescriptor.CAN_SPAWN, new ArrayList<>(Collections.singletonList(TileTags.WALKABLE)), true)));
